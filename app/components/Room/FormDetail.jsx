...
function FormDetail({ Room }) {
  ...
  const filterCheckInDates = (date) => {
    ...
    potentialCheckOutAfterOneNight.setUTCDate(
      potentialCheckOutAfterOneNight.getUTCDate() + 1
    );
    const normalizedPotentialCheckOut = normalizeDateToUTC(
      potentialCheckOutAfterOneNight
    );
  ...
  const calculateDaysDifference = () => {
    ...
    const timeDifference =
      normalizeDateToUTC(checkOutDate).getTime() -
      normalizeDateToUTC(checkInDate).getTime();
            ...
            <DatePicker
              ...
              onChange={(date) => {
                if (date) {
                  ...
                  if (
                    checkOutDate &&
                    normalizeDateToUTC(date).getTime() >=
                      normalizeDateToUTC(checkOutDate).getTime()
                  ) {
                    setCheckOutDate(null);
                  }
